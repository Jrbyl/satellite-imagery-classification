...
def main():
    ...
    train_root = Path("C:/satellite-imagery-classification/usa_europe_patches_512/train")
    val_root   = Path("C:/satellite-imagery-classification/usa_europe_patches_512/val")
    test_root  = Path("C:/satellite-imagery-classification/usa_europe_patches_512/test")
